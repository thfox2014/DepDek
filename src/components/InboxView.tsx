...
export default function InboxView({ onStartTask, onUpdateTask, onInboxCountChange, onOpenAppConfig }: TaskReporter & { onInboxCountChange?: (previewCount?: number) => void; onOpenAppConfig?: () => void }) {
